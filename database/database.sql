/******************************************************************************/
/***          Generated by IBExpert 2012.02.06 22.11.2015 20:00:52          ***/
/******************************************************************************/
...
CREATE OR ALTER PROCEDURE ABSENT_TAB_PART_2
RETURNS (
...
CREATE OR ALTER PROCEDURE ADD_CURR_CAT (
    CURR_ID INTEGER,
    CLASS_NUM INTEGER,
    CAT INTEGER)
AS
...
CREATE OR ALTER PROCEDURE ADD_CURR_REC (
    CURR_ID INTEGER,
    ID INTEGER,
    SUBJ_ID INTEGER,
    GROUP_QTY INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_CURR_REC_TIME (
    CURR_ID INTEGER,
    CURR_REC_ID INTEGER,
    CLASS_NUM INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_CURRICULUM (
    INID INTEGER,
    INNAME VARCHAR(150),
    INPERIOD INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_EDUCATION (
    INID INTEGER,
    INNAME VARCHAR(30))
RETURNS (
    OUTID INTEGER)
...
CREATE OR ALTER PROCEDURE ADD_FILIAL (
    INID INTEGER,
    INCODE INTEGER,
    INNAME VARCHAR(30),
    ININFO VARCHAR(50))
...
CREATE OR ALTER PROCEDURE ADD_GROUPING (
    IN_ID INTEGER,
    IN_NAME VARCHAR(30),
...
CREATE OR ALTER PROCEDURE ADD_GROUPING_DEPT (
...
CREATE OR ALTER PROCEDURE ADD_GROUPING_SUBJ (
    IN_GROUPING_ID INTEGER,
    IN_SUBJ_ID INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_GROUPING_SUBJ_CURR (
    IN_GROUPING_ID INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_LEARN_TIME_GRID (
    ID INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_LTG_GROUPING (
    LTG_ID INTEGER,
    GROUPING_ID INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE ADD_LTG_I_SUBJ_CURR (
    LTG_ID INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_LTG_I_SUBJECT (
    LTG_ID INTEGER,
    I_SUBJ_ID INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_REP_TAB (
    ID INTEGER,
    T_ID INTEGER,
    TAB_NUM INTEGER,
    T_NAME VARCHAR(100),
...
CREATE OR ALTER PROCEDURE ADD_REP_TAB_EXT (
...
CREATE OR ALTER PROCEDURE ADD_REP_TAB_EXT_2 (
    IN_REC_TIME TIMESTAMP,
    IN_TEACHER_NAME VARCHAR(100),
    IN_TAB_MONTH DATE,
    IN_Y_T DOUBLE PRECISION,
...
CREATE OR ALTER PROCEDURE ADD_REPORT_PARAM (
    IN_ID INTEGER,
    IN_NAME VARCHAR(30),
...
CREATE OR ALTER PROCEDURE ADD_STUDENT_FILTER (
    IN_ID INTEGER,
    IN_NAME VARCHAR(30),
...
CREATE OR ALTER PROCEDURE ADD_STUDENT_FILTER_SPEC (
    ID_FILTER INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_STUDENT_PLAN (
    IN_CURR_REC_ID INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_SUBJECT (
    INID INTEGER,
    INCODE INTEGER,
    INNAME VARCHAR(30),
    ININFO VARCHAR(50),
...
CREATE OR ALTER PROCEDURE ADD_TARIFF (
    INGRADE INTEGER,
...
CREATE OR ALTER PROCEDURE ADD_TEACHER_ADDING (
    INID INTEGER,
    INTEACHERID INTEGER,
    INNAME VARCHAR(30),
    INPERCENT SMALLINT,
...
CREATE OR ALTER PROCEDURE ADD_TEACHER_CAT_KIND (
    P_ID INTEGER,
    P_NAME VARCHAR(150),
    P_PRINT VARCHAR(255),
...
CREATE OR ALTER PROCEDURE ADD_TEACHER_FILTER (
    IN_ID INTEGER,
    IN_NAME VARCHAR(30),
...
CREATE OR ALTER PROCEDURE ADD_TEACHER_GROUP (
    GROUPING_ID INTEGER,
    TEACHER_ID INTEGER,
    GR_SUBJ_ID INTEGER,
    CLASS_NUM INTEGER,
...
CREATE OR ALTER PROCEDURE CG_ADD (
...
CREATE OR ALTER PROCEDURE CG_DELETE (
    ID INTEGER,
    ID_CALC_PACK INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE CG_FILL_FROM_GROUPING (
    ID_CALC_PACK INTEGER,
...
CREATE OR ALTER PROCEDURE CG_FOOTER_CHANGE (
    ID INTEGER,
    ID_CALC_PACK INTEGER,
    FOOTER VARCHAR(3000))
AS
...
CREATE OR ALTER PROCEDURE CG_HEADER_CHANGE (
    ID INTEGER,
    ID_CALC_PACK INTEGER,
    HEADER VARCHAR(3000))
AS
...
CREATE OR ALTER PROCEDURE CG_NAME_CHANGE (
    ID INTEGER,
    ID_CALC_PACK INTEGER,
    NAME VARCHAR(50))
AS
...
CREATE OR ALTER PROCEDURE CG_RECALCULATE (
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE CG_SHOW_POSITION_CHANGE (
    ID INTEGER,
    ID_CALC_PACK INTEGER,
    SHOW_POSITION INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CGCD_ADD (
...
CREATE OR ALTER PROCEDURE CGCD_CATEGORY_CHANGE (
    CLASS_NUMBER INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER,
    CATEGORY SMALLINT)
...
CREATE OR ALTER PROCEDURE CGCD_QTY_STUDENT_CHANGE (
    CLASS_NUMBER INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER,
    QTY_STUDENT SMALLINT)
...
CREATE OR ALTER PROCEDURE CGS_ADD (
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER,
    NAME VARCHAR(50),
    ID_GROUPING INTEGER,
...
CREATE OR ALTER PROCEDURE CGS_DELETE (
    ID INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CGS_MOVE_DOWN (
    ID INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CGS_MOVE_UP (
    ID INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CGS_NAME_CHANGE (
    ID INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER,
    NAME VARCHAR(50))
...
CREATE OR ALTER PROCEDURE CGSCD_ADD (
...
CREATE OR ALTER PROCEDURE CGSCD_CLOCK_CURR (
    CLASS_NUMBER SMALLINT,
    ID_CALC_GROUP_SUBJECT INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER,
...
CREATE OR ALTER PROCEDURE CGSCD_CLOCK_CURR_CHANGE (
    CLASS_NUMBER SMALLINT,
    ID_CALC_GROUP_SUBJECT INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER,
...
CREATE OR ALTER PROCEDURE CGSCD_DELETE (
    CLASS_NUMBER SMALLINT,
    ID_CALC_GROUP_SUBJECT INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER)
...
CREATE OR ALTER PROCEDURE CGSCD_QTY_FACT_CHANGE (
    CLASS_NUMBER SMALLINT,
    ID_CALC_GROUP_SUBJECT INTEGER,
    ID_CALC_GROUP INTEGER,
    ID_CALC_PACK INTEGER,
...
CREATE OR ALTER PROCEDURE CHANGE_CONSTANTS (
...
CREATE OR ALTER PROCEDURE CHANGE_SYS_DATE (
    IN_DATE DATE)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE CHECK_ORDERED (
...
CREATE OR ALTER PROCEDURE CI_ADD (
    ID_CALC_PACK INTEGER,
    NAME VARCHAR(50),
    HEADER VARCHAR(3000),
    FOOTER VARCHAR(3000),
...
CREATE OR ALTER PROCEDURE CI_DELETE (
    ID INTEGER,
    ID_CALC_PACK INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE CI_FILL_FROM_CURR_DEPT (
    ID_CALC_PACK INTEGER,
...
CREATE OR ALTER PROCEDURE CI_FILL_FROM_DEPT (
    ID_CALC_PACK INTEGER,
...
CREATE OR ALTER PROCEDURE CI_FOOTER_CHANGE (
    ID INTEGER,
    ID_CALC_PACK INTEGER,
    FOOTER VARCHAR(3000))
AS
...
CREATE OR ALTER PROCEDURE CI_HEADER_CHANGE (
    ID INTEGER,
    ID_CALC_PACK INTEGER,
    HEADER VARCHAR(3000))
AS
...
CREATE OR ALTER PROCEDURE CI_NAME_CHANGE (
    ID INTEGER,
    ID_CALC_PACK INTEGER,
    NAME VARCHAR(50))
AS
...
CREATE OR ALTER PROCEDURE CI_RECALCULATE (
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE CI_SHOW_POSITION_CHANGE (
    ID INTEGER,
    ID_CALC_PACK INTEGER,
    SHOW_POSITION INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CICD_ADD (
    CLASS_NUMBER INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER,
    CATEGORY SMALLINT,
...
CREATE OR ALTER PROCEDURE CICD_CATEGORY_CHANGE (
    CLASS_NUMBER INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER,
    CATEGORY SMALLINT)
...
CREATE OR ALTER PROCEDURE CICD_DELETE (
    CLASS_NUMBER INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CICD_QTY_STUDENT_CHANGE (
    CLASS_NUMBER INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER,
    QTY_STUDENT SMALLINT)
...
CREATE OR ALTER PROCEDURE CIS_ADD (
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER,
    NAME VARCHAR(50),
    ID_DEPARTMENT INTEGER,
...
CREATE OR ALTER PROCEDURE CIS_DELETE (
    ID INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CIS_MOVE_DOWN (
    ID INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CIS_MOVE_UP (
    ID INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER)
AS
...
CREATE OR ALTER PROCEDURE CIS_NAME_CHANGE (
    ID INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER,
    NAME VARCHAR(50))
...
CREATE OR ALTER PROCEDURE CISCD_ADD (
    CLASS_NUMBER INTEGER,
...
CREATE OR ALTER PROCEDURE CISCD_CLOCK_CURR_CHANGE (
    CLASS_NUMBER INTEGER,
    ID_CALC_INDIVIDUAL_SUBJECT INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER,
...
CREATE OR ALTER PROCEDURE CISCD_DELETE (
    CLASS_NUMBER INTEGER,
    ID_CALC_INDIVIDUAL_SUBJECT INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER,
...
CREATE OR ALTER PROCEDURE CISCD_QTY_FACT_CHANGE (
    CLASS_NUMBER INTEGER,
    ID_CALC_INDIVIDUAL_SUBJECT INTEGER,
    ID_CALC_INDIVIDUAL INTEGER,
    ID_CALC_PACK INTEGER,
...
CREATE OR ALTER PROCEDURE CLEAR_STUDENT_FILTER_SPEC (
    ID_FILTER INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE CONST_ADD (
    P_CODE VARCHAR(150),
    P_NAME VARCHAR(150),
    P_TYPE INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE CONST_FLOAT_SET (
    P_CODE VARCHAR(150),
...
CREATE OR ALTER PROCEDURE CP_ADD_EDIT (
    ID INTEGER,
    NAME VARCHAR(50))
RETURNS (
    OUT_ID INTEGER)
...
CREATE OR ALTER PROCEDURE CP_DELETE (
    ID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_CURRICULUM (
    ID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_CURRICULUM_RECORD (
    INID INTEGER,
    INCURRID INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE DELETE_EDUCATION (
    INID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_FILIAL (
    INID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_GROUPING (
    IN_ID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_GROUPING_DEPT (
    IN_GROUPING_ID INTEGER,
    IN_DEPT_ID INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE DELETE_REP_TAB_EXT (
    IN_REC_TIME TIMESTAMP)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_REP_TAB_EXT_2 (
    IN_REC_TIME TIMESTAMP)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_STUDENT_PLAN (
    IN_CURR_REC_ID INTEGER,
    INSTUDENTID INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE DELETE_SUBJECT (
    INID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_TARIFF (
    INGRADE INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_TARIFFICATION (
    IN_DATE TIMESTAMP)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_TEACHER (
    INID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE DELETE_TEACHER_ADDING (
    INID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE EDIT_MAIN_TAB (
    T_ID INTEGER,
...
CREATE OR ALTER PROCEDURE GET_CURR_STAGE (
    STAGE_ON_DATE DATE,
    STAGE_Y SMALLINT,
    STAGE_M SMALLINT,
    STAGE_D SMALLINT)
...
CREATE OR ALTER PROCEDURE GET_CURRS_STUDENTS_QTY (
    CURR_REC_ID INTEGER,
    FINANCING_ID INTEGER,
    CURR_ID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE GET_FILTERED_TEACHERS (
    FILTER_ID INTEGER)
RETURNS (
    TEACHER_ID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE GET_FILTRED_STUDENT (
    ID_FILTER INTEGER)
RETURNS (
    ID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE GET_QUALIFICATION_ID (
    NAME VARCHAR(256))
RETURNS (
    ID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE GET_ST_I_SUBJ_CLOCKS_CSV (
    TEACHER_ID INTEGER,
    STUDENT_ID INTEGER)
RETURNS (
    CLOCKS VARCHAR(3000))
...
CREATE OR ALTER PROCEDURE GET_TEACHER_CAT_LIST (
    ID_TEACHER INTEGER,
    ID_GROUP INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE GET_TEACHER_TIME_AND_PAY (
    TEACHER_ID INTEGER,
    FINANCING INTEGER)
RETURNS (
    PED_TIME DOUBLE PRECISION,
    CONC_TIME DOUBLE PRECISION,
    PED_PAY DOUBLE PRECISION,
    CONC_PAY DOUBLE PRECISION,
    SUM_PAY DOUBLE PRECISION,
    SUM_TIME DOUBLE PRECISION,
    ADD_SUM DOUBLE PRECISION)
AS
BEGIN
  SUSPEND;
END^
...
CREATE OR ALTER PROCEDURE GET_TEACHER_TIME_AND_PAY_ALL (
    TEACHER_ID INTEGER)
RETURNS (
    PED_TIME_B DOUBLE PRECISION,
    PED_TIME_S DOUBLE PRECISION,
    CONC_TIME_B DOUBLE PRECISION,
    CONC_TIME_S DOUBLE PRECISION,
    PED_PAY_B DOUBLE PRECISION,
    PED_PAY_S DOUBLE PRECISION,
    CONC_PAY_B DOUBLE PRECISION,
    CONC_PAY_S DOUBLE PRECISION,
    SUM_PAY_B DOUBLE PRECISION,
    SUM_PAY_S DOUBLE PRECISION,
    SUM_PAY DOUBLE PRECISION,
    SUM_TIME_B DOUBLE PRECISION,
    SUM_TIME_S DOUBLE PRECISION,
    ADD_SUM DOUBLE PRECISION,
...
CREATE OR ALTER PROCEDURE GET_TEACHERS_TM
RETURNS (
    TEACHER_ID INTEGER,
...
CREATE OR ALTER PROCEDURE MAIN_TAB_PART_2
RETURNS (
    ABSENCE_CODES VARCHAR(255),
    TEACHER_TAB_NUM INTEGER,
    CLOCK_Y INTEGER,
...
CREATE OR ALTER PROCEDURE NAME_TO_FAMILY_AND_INITIALS (
    NAME VARCHAR(256))
RETURNS (
    FAMILY_AND_INITIALS VARCHAR(256))
AS
BEGIN
  SUSPEND;
END^
...
CREATE OR ALTER PROCEDURE POS_CHANGE (
    P_TABLE_NAME VARCHAR(150),
    P_ORDER_BY VARCHAR(1000),
    P_ID INTEGER,
    P_STEEP INTEGER)
...
CREATE OR ALTER PROCEDURE POS_DEC (
    P_TABLE_NAME VARCHAR(150),
    P_ID INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE POS_INC (
    P_TABLE_NAME VARCHAR(150),
    P_ID INTEGER)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE PROC_ALL_TEACHER_GROUP (
    IN_GROUPING_ID INTEGER,
    IN_TEACHER_ID INTEGER)
RETURNS (
    GROUPING_ID INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_CALC_TEACHER_GROUP (
    IN_GROUPING_ID INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_CALC_TEACHER_GROUP_EXT (
    IN_GROUPING_ID INTEGER,
    IN_TEACHER_ID INTEGER,
    IN_REPL_TYPE INTEGER)
AS
...
CREATE OR ALTER PROCEDURE PROC_CURR_REC_REPORT (
    IN_CURR_ID INTEGER,
    IN_FINANCING_ID INTEGER)
RETURNS (
    CURR_REC_ID INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_CURR_REPORT (
    IN_CURR_ID INTEGER,
    IN_FINANCING_ID INTEGER)
RETURNS (
    Q_0 INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_EXTRACT_ALL_GROUP (
    IN_GROUPING_ID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE PROC_EXTRACT_GR_SUBJECTS (
...
CREATE OR ALTER PROCEDURE PROC_FILL_TEACHER_TM
RETURNS (
    TEACHER_ID INTEGER,
    FINANCING_ID INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_FOR_STUDENT_FILTER (
    ID_FILTER INTEGER)
RETURNS (
    STUDENTID INTEGER)
AS
...
CREATE OR ALTER PROCEDURE PROC_GET_TEACHER_GROUP_W_ST_QTY (
    IN_GROUPING_ID INTEGER,
    IN_TEACHER_ID INTEGER,
    IN_GR_SUBJ_ID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE PROC_LTG_REPORT (
    IN_LTG_ID INTEGER)
RETURNS (
    Q_0 INTEGER,
    Q_1 INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_LTG_REPORT_REC_G (
    IN_LTG_ID INTEGER)
RETURNS (
    G_SUBJ_ID INTEGER,
    SUBJECT_NAME VARCHAR(30),
...
CREATE OR ALTER PROCEDURE PROC_LTG_REPORT_REC_I (
    IN_LTG_ID INTEGER)
RETURNS (
    LTG_SUBJ_ID INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_MAIN_TAB (
    DAYS_QTY INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE PROC_NEW_TARIFFICATION (
    IN_INFO VARCHAR(50))
RETURNS (
    OUT_DATE TIMESTAMP)
AS
...
CREATE OR ALTER PROCEDURE PROC_PREPARE_GR_CURR (
    GROUPING_ID INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE PROC_STUDENT_PLAN (
    INID INTEGER,
    INSTUDENTID INTEGER,
    INSPECID INTEGER,
    INCLASSNUM INTEGER)
...
CREATE OR ALTER PROCEDURE PROC_TEACHER_GROUP (
    IN_GROUPING_ID INTEGER)
RETURNS (
    GROUPING_ID INTEGER,
    TEACHER_ID INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_TEACHER_GROUP_CLS (
    GROUPING_ID INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_TEACHER_GROUP_ST_QTY (
    IN_GROUPING_ID INTEGER,
    IN_TEACHER_ID INTEGER)
RETURNS (
    GROUPING_ID INTEGER,
...
CREATE OR ALTER PROCEDURE PROC_TEACHER_REPORT (
    ID_TEACHER INTEGER,
    ID_DEPARTMENT INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE PROC_TEACHER_TM (
    INTEACHERID INTEGER,
    INFINANCING INTEGER)
RETURNS (
...
CREATE OR ALTER PROCEDURE TABLE_BOOKMARK_D (
...
CREATE OR ALTER PROCEDURE TABLE_BOOKMARK_IU (
    TABLE_NAME VARCHAR(50),
    BOOKMARK VARCHAR(50))
AS
BEGIN
...
CREATE OR ALTER PROCEDURE TEACHER_ABSENT_CODES (
    TEACHER_ID INTEGER,
    THE_DAY DATE)
RETURNS (
    CODE VARCHAR(150))
...
CREATE OR ALTER PROCEDURE TEACHER_ABSENT_DATA_EDIT (
    TEACHER_ID INTEGER,
    COMMENTS VARCHAR(256))
AS
BEGIN
...
CREATE OR ALTER PROCEDURE TEACHER_ABSENTS_CLEAR (
    TEACHER_ID INTEGER)
AS
BEGIN
  EXIT;
...
CREATE OR ALTER PROCEDURE TEACHER_ABSENTS_EDIT (
    TEACHER_ID INTEGER,
    DATE_FROM DATE,
    DATE_TO DATE,
    ABSENTS VARCHAR(256))
...
CREATE OR ALTER PROCEDURE TEACHER_CAT_EDIT (
    P_ID INTEGER,
...
CREATE OR ALTER PROCEDURE TT_ADD (
    P_ID_TEACHER INTEGER,
    P_ID_KIND INTEGER,
    P_DATE DATE,
...
CREATE OR ALTER PROCEDURE UPDATE_CURR_REC_NUMS
AS
BEGIN
  EXIT;
END^
...
CREATE OR ALTER VIEW V_CALC_G_SUBJECT(
    ID,
    ID_CALC_GROUP,
    ID_CALC_PACK,
    NAME_SUBJECT,
...
/* View: V_CALC_GROUP */
CREATE OR ALTER VIEW V_CALC_GROUP(
    ID_CALC_PACK,
    ID,
    SHOW_POSITION,
    NAME,
...
CREATE OR ALTER VIEW V_CALC_GROUP_SUBJECT(
    ID_CALC_PACK,
    ID_CALC_GROUP,
    ID,
    SHOW_POSITION,
...
CREATE OR ALTER VIEW V_CALC_I_SUBJECT(
    ID,
    ID_CALC_INDIVIDUAL,
    ID_CALC_PACK,
    NAME_SUBJECT,
...
CREATE OR ALTER VIEW V_CALC_INDIVIDUAL(
    ID_CALC_PACK,
    ID_CALC_INDIVIDUAL,
    NAME,
    HEADER,
...
CREATE OR ALTER VIEW V_CALC_INDIVIDUAL_SUBJECT(
    ID_CALC_PACK,
    ID_CALC_INDIVIDUAL,
    ID,
    SHOW_POSITION,
...
/* View: V_CONST_FLOAT */
CREATE OR ALTER VIEW V_CONST_FLOAT(
    ID,
    F_CODE,
    F_NAME,
    F_VALUE)
...
CREATE OR ALTER VIEW V_CURR_INDIVIDUAL(
    CURRICULUM_ID,
    SUBJECT_ID,
    SUBJECT_NAME,
    Q_0,
...
/* View: V_CURRICULUM */
CREATE OR ALTER VIEW V_CURRICULUM(
    ID,
    NAME,
    PERIOD_FOR_PRINT,
    PERIOD,
...
CREATE OR ALTER VIEW V_CURRICULUM_CAT(
    ID,
    C_0,
    C_1,
    C_2,
...
CREATE OR ALTER VIEW V_CURRICULUM_REC(
    ID,
    CURR_ID,
    NUM,
    SUBJ_ID,
...
CREATE OR ALTER VIEW V_CURRICULUM_SUM(
    ID,
    T0YO,
    T1YO,
    T2YO,
...
select
  ...
  sum(case when S."Code" <> 1 then coalesce(CRT.c_time, 0)                   end) SUM_PED,
  sum(case when S."Code" =  1 then coalesce(CRT.c_time, 0)                   end) SUM_CONC,
...
/* View: V_DEPARTMENT */
CREATE OR ALTER VIEW V_DEPARTMENT(
    ID,
    CODE,
    NAME,
    INFO,
...
/* View: V_DEPT_IND_QTY */
CREATE OR ALTER VIEW V_DEPT_IND_QTY(
    ID,
    DEPT_NAME,
    PERIOD,
    CAT_0,
...
CREATE OR ALTER VIEW V_LTG_I_SUBJ_RECORD(
    LTG_ID,
    LTG_SUBJECT_ID,
    POS_SUBJECT,
    NAME_SUBJECT,
...
CREATE OR ALTER VIEW V_LTG_TOTAL_TABLE(
    T5_Y,
    T5_O,
    T5_C,
    T5_V_Y,
...
CREATE OR ALTER VIEW V_MAIN_TAB_PARAMS(
    CURR_MONTH_DAYS_QTY,
...
CREATE OR ALTER VIEW V_TEACHER_ABSENT_CODES(
    TEACHER_ID,
    ABSENT_DATE,
    CODES)
AS
...
CREATE OR ALTER VIEW V_MAIN_TAB_PART_1(
    TEACHER_ID,
    TEACHER_NAME,
    TEACHER_POST,
    DAY_1,
...
/* View: V_TEACHER */
CREATE OR ALTER VIEW V_TEACHER(
    ID,
    TAB_NUM,
    "Name",
    "FilialID",
...
/* View: V_R_EDUCATION */
CREATE OR ALTER VIEW V_R_EDUCATION(
    TEACHER_ID,
    TEACHER_NAME,
    POST_NAME,
    SUBJECT_NAME,
...
CREATE OR ALTER VIEW V_STUDENT_CURATOR_CLOCK(
    ID_STUDENT,
    ID_TEACHER,
    TIME_Y,
    TIME_O,
...
CREATE OR ALTER VIEW V_TEACHER_GROUP_TIME(
    ID_TEACHER,
    ID_GROUPING,
    ID_GROUPING_SUBJ,
    CLASS_NUM,
...
/* View: V_R_FOR_TEACHER_BY_STUDENTS_FLT */
CREATE OR ALTER VIEW V_R_FOR_TEACHER_BY_STUDENTS_FLT(
    REP_PART,
    NAME,
    CLASS_AND_PERIOD,
    SPECIALIZATION,
...
from (
  select
    1 as rep_part,
    vst.name,
    vst.class || '(' || vst.period || ')' as class_and_period,
    vst.specialization,
    nai.family_and_initials curator,
    null qty_p,
    coalesce(vscc.time_y, 0) + coalesce(vscc.time_o, 0) time_p,
    vscc.time_c,
    clc.clocks
  from get_filtred_student(1) fs
    left join student_filter stf on stf.id = 1
    left join view_student vst ON vst.id = fs.id
    left join name_to_family_and_initials(vst.curator) nai on 1 = 1
    inner join v_student_curator_clock vscc ON
      fs.id = vscc.id_student
    left join get_st_i_subj_clocks_csv(stf.teacher_id_1, fs.id) CLC ON 1 = 1
  where vscc.id_teacher = stf.teacher_id_1
  union all
  select
    2 as rep_part,
    gs.name,
    vtgt.class_num || vtgt.period || ')' as class_and_period,
    null specialization,
    null curator,
    vtgt.qty_y + vtgt.qty_o qty_p,
    coalesce(vtgt.time_y, 0) + coalesce(vtgt.time_o, 0) time_p,
    vtgt.time_c,
    null clocks
  ...
  where vtgt.id_teacher = stf.teacher_id_1
)
order by rep_part, name
;



/* View: V_R_STAGE */
CREATE OR ALTER VIEW V_R_STAGE(
    TEACHER_ID,
    TEACHER_NAME,
    POST_NAME,
    SUBJECT_NAME,
...
CREATE OR ALTER VIEW V_TARIFFICATION(
    DOC_DATE,
    INFO,
    SYS_DATE,
    COEF_Y_TIME,
...
/* View: V_TAR_RECORD */
CREATE OR ALTER VIEW V_TAR_RECORD(
    DOC_DATE,
    TEACHER_ID,
    T_NAME,
    T_POST,
...
CREATE OR ALTER VIEW V_R_TEACHER_PERCENTS(
    TEACHER_NAME,
    TEACHER_POST,
    TEACHER_CAT_NAME,
...
/* View: V_R_TEACHERS_LOADING */
CREATE OR ALTER VIEW V_R_TEACHERS_LOADING(
    ID,
    NAME,
    SUBJECT_NAME,
    EDUCATION_NAME,
...
select
  ...
  tap.sum_time_b
from v_teacher t
  left join get_teacher_time_and_pay_all(t.id) tap on 1 = 1
order by 1
;



/* View: V_R_TEACHERS_LOADINGS */
CREATE OR ALTER VIEW V_R_TEACHERS_LOADINGS(
    NAME,
    SUBJECT_NAME,
    EDUCATION_NAME,
    POST_NAME,
...
select
  ...
  tap.conc_time_b,
  tap.sum_time_b
from get_filtered_teachers(1) ft
  left join v_teacher t on t.id = ft.teacher_id
  left join get_teacher_time_and_pay_all(t.id) tap on 1 = 1
order by 1
;
...
CREATE OR ALTER VIEW V_STUDENT_CURRENT(
    ID,
    CODE,
    NAME,
    SPECIALIZATIONID,
...
CREATE OR ALTER VIEW V_STUDENT_FILTER(
    ID,
    NAME,
    FILIAL_ID,
    FILIAL_NAME,
...
CREATE OR ALTER VIEW V_STUDENT_FILTER_SPEC(
    ID_FILTER,
    ID_SPECIALIZATION,
    SPEC_NAME)
AS
...
CREATE OR ALTER VIEW V_T_MATERIAL_STIMULUS(
    NAME,
    TAB_NUMBER,
    POST_NAME,
    MONEY)
...
CREATE OR ALTER VIEW V_T_MATERIAL_STIMULUS_XML(
    ROW)
AS
...
/* View: V_TAR_TOTALS */
CREATE OR ALTER VIEW V_TAR_TOTALS(
    DOC_DATE,
    T_Y_PT,
    T_Y_FT,
    T_O_PT,
...
CREATE OR ALTER VIEW V_TEACHER_ABSENT_MONTH_DATA(
    TEACHER_ID,
    COMMENTS)
AS
...
CREATE OR ALTER VIEW V_TEACHER_CAT_KIND(
    ID,
    NAME)
AS
...
CREATE OR ALTER VIEW V_TEACHER_TITLE_KIND(
    ID,
    NAME)
AS
...
/* View: V_TF_EDUCATION */
CREATE OR ALTER VIEW V_TF_EDUCATION(
    F_TF_ID,
    F_ID,
    F_NAME,
    F_CHECKED)
...
/* View: V_TF_POST */
CREATE OR ALTER VIEW V_TF_POST(
    F_TF_ID,
    F_ID,
    F_NAME,
    F_CHECKED)
...
/* View: V_TF_TITLE */
CREATE OR ALTER VIEW V_TF_TITLE(
    F_TF_ID,
    F_ID,
    F_NAME,
    F_CHECKED)
...
/* View: VIEW_CURR_CAT */
CREATE OR ALTER VIEW VIEW_CURR_CAT(
    CURR_ID,
    C_0,
    C_1,
    C_2,
...
CREATE OR ALTER VIEW VIEW_GROUP_CURR_SUBJ(
    CURR_ID,
    CURR_REC_ID,
    CURR_REC_NUM,
    SUBJECT_ID,
...
CREATE OR ALTER VIEW VIEW_GROUPING_CURR(
    GROUPING_ID,
    CURR_ID,
    CURR_NAME)
AS
...
CREATE OR ALTER VIEW VIEW_GROUPING_DEPT(
    GROUPING_ID,
    DEPT_ID,
    DEPT_NAME,
    DEPT_INFO)
...
CREATE OR ALTER VIEW VIEW_GROUPING_SUBJ(
    GROUPING_ID,
    GR_SUBJ_ID,
    GR_SUBJ_NAME,
    GR_SUBJ_CODE,
...
CREATE OR ALTER VIEW VIEW_GROUPING_SUBJS(
    GROUPING_ID,
    GROUPING_SUBJ_ID,
    CURR_ID,
    CURR_NAME,
...
CREATE OR ALTER VIEW VIEW_STUDENT_CATEGORY(
    STUDENTID,
    CATEGORY)
AS
...
CREATE OR ALTER VIEW VIEW_STUDENT_PLAN(
    STUDENT_ID,
    ID,
    NUM,
    USE,
...
CREATE OR ALTER VIEW VIEW_STUDENT_QTY(
    GROUPING_ID,
    TEACHER_ID,
    GR_SUBJ_ID,
    QTY_0,
...
CREATE OR ALTER VIEW VIEW_TEACHER_FILTER(
    ID,
    NAME,
    MAIN_SUBJ_ID,
    MAIN_SUBJ_NAME,
...
CREATE OR ALTER VIEW VIEW_TEACHER_GROUP(
    GROUPING_ID,
    TEACHER_ID,
    TEACHER_NAME,
    GS_0,
...
CREATE OR ALTER VIEW VIEW_TEACHER_GROUP_AND_ST_QTY(
    GROUPING_ID,
    GR_SUBJ_ID,
    GR_SUBJ_NAME,
    GR_SUBJ_CODE,
...
CREATE OR ALTER TRIGGER CURR_REC_AD0 FOR CURR_REC
...
CREATE OR ALTER TRIGGER GROUPING_SUBJ_AD0 FOR GROUPING_SUBJ
ACTIVE AFTER DELETE POSITION 0
AS
begin
...
CREATE OR ALTER TRIGGER LTG_I_SUBJECT_AD0 FOR LTG_I_SUBJECT
ACTIVE AFTER DELETE POSITION 0
AS
begin
...
CREATE OR ALTER TRIGGER OBJECT_KIND_BI FOR OBJ_KIND
...
CREATE OR ALTER TRIGGER OBJECT_NOTE_KIND_BI FOR OBJ_NOTE_KIND
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.f_id is null) then
...
CREATE OR ALTER TRIGGER OBJ_CAT_GROUP_BI FOR OBJ_CAT_GROUP
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.f_id is null) then
...
/* Trigger: SEX_BI */
CREATE OR ALTER TRIGGER SEX_BI FOR SEX
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.f_id is null) then
...
/* Trigger: TBI_CGS */
CREATE OR ALTER TRIGGER TBI_CGS FOR CALC_GROUP_SUBJECT
ACTIVE BEFORE INSERT POSITION 0
AS
BEGIN
...
CREATE OR ALTER TRIGGER TEACHER_CAT_KIND_BI FOR TEACHER_CAT_KIND
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.f_id is null) then
...
CREATE OR ALTER TRIGGER TEACHER_TITLE_KIND_BI FOR TEACHER_TITLE_KIND
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.f_id is null) then
...
/* Trigger: T_BI_OCK */
CREATE OR ALTER TRIGGER T_BI_OCK FOR OBJ_CAT_KIND
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.f_id is null) then
...
/* Trigger: T_BI_ONT */
CREATE OR ALTER TRIGGER T_BI_ONT FOR OBJ_NOTE_TYPE
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.f_id is null) then
...
/* Trigger: T_BI_TN */
CREATE OR ALTER TRIGGER T_BI_TN FOR TEACHER_NOTE
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.f_id is null) then
...
CREATE OR ALTER TRIGGER T_CIS_CURRICULUM FOR CALC_INDIVIDUAL_SUBJECT
ACTIVE BEFORE INSERT POSITION 0
AS
begin
...
begin
  v_start_date = dateadd(-coalesce(:stage_d, 0) day to :stage_on_date);
  v_start_date = dateadd(-coalesce(:stage_m, 0) month to v_start_date);
  v_start_date = dateadd(-coalesce(:stage_y, 0) year to v_start_date);
  --cast(addday(addyear(addmonth(:stage_on_date, -coalesce(:stage_m, 0)), -coalesce(:stage_y, 0)),-coalesce(:stage_d, 0)) as date);
  v_curr_date  = cast(current_date as date);
  v_months = datediff(month, v_start_date, v_curr_date);
  curr_stage_m = mod(v_months, 12);
  curr_stage_y = div(v_months, 12);
  suspend;
end^
...
RETURNS (
    ...
    ADD_SUM DOUBLE PRECISION)
AS
  declare variable conc_ind_time   double precision;
  declare variable ped_ind_time    double precision;
  declare variable ped_group_time  double precision;
  declare variable conc_group_time double precision;
  declare variable main_salary     double precision;
  declare variable conc_salary     double precision;
  declare variable ped_coef        double precision;
  declare variable conc_coef       double precision;
...
begin
  ...
  from "Student_Plan" STP
    join "Student" S on STP."Use" > 0 and
      S.id = STP."StudentID" and S."FinancingID" = :financing and
      S.released = 0 and S.academy = 0 and STP."TeacherID" = :teacher_id
    join "Specialization" SP on SP.id = S."SpecializationID"
    join "Department" D on D.id = SP."DepartmentID"
    ...
    join "Teacher" T on T."ID" = :teacher_id and T."ReleaseDate" is null
  into :conc_ind_time, :ped_ind_time;

  -- групповые часы не концертмейстерские
  select
    -- пед. часы
    sum(TG.group_q*CRT.c_time)
  from grouping G join teacher_group TG on G.id = TG.grouping_id and
      G.financing_id = :financing and TG.teacher_id = :teacher_id
  ...
  where CC.curr_id in (select min(GSCN1.curr_id) from grouping_subj_curr_id GSCN1
     where GSCN1.grouping_id = GSCN.grouping_id and
           GSCN1.grouping_subj_id = GSCN.grouping_subj_id)
  into :conc_group_time;

  ped_time = nullif(coalesce(ped_ind_time, 0) + coalesce(ped_group_time, 0), 0);
  conc_time = nullif(coalesce(conc_ind_time, 0) + coalesce(conc_group_time, 0), 0);

  -- получаем тарифные ставки
  select c.f_value from v_const_float c where c.f_code = 'Rate.Teacher'       into :main_salary; -- преподавательская
  select c.f_value from v_const_float c where c.f_code = 'Rate.Concertmaster' into :conc_salary; -- концертмейстерская

  select distinct ytcoef, ctcoef from constants into :ped_coef, :conc_coef;
  ped_pay = cast(trunc(main_salary / ped_coef * ped_time, 2) as numeric(10, 2));
  conc_pay = cast(trunc(conc_salary / conc_coef * conc_time, 2) as numeric(10, 2));
  sum_pay = nullif(coalesce(ped_pay, 0) + coalesce(conc_pay, 0), 0);
  sum_time = nullif(coalesce(ped_time, 0) + coalesce(conc_time, 0), 0);

  select
    coalesce(sum(TA."Percent"/100 * :main_salary), 0),
    coalesce(sum(TA."Sum"), 0)
  from "Teacher_Addings" TA join "Teacher" T on
    TA."TeacherID" = :teacher_id and T."ID" = :teacher_id
  where T."ReleaseDate" is null
  into :psum, :msum;

  add_sum = nullif(psum + msum, 0);
...
begin
  select
    t0.ped_time, t1.ped_time,
    t0.conc_time, t1.conc_time,
    t0.ped_pay, t1.ped_pay,
    t0.conc_pay, t1.conc_pay,
    t0.sum_pay, t1.sum_pay,
    t0.sum_time, t1.sum_time,
    t0.add_sum
  from
    get_teacher_time_and_pay(:teacher_id, 0) t0,
    get_teacher_time_and_pay(:teacher_id, 1) t1
  into
    :PED_TIME_B, :PED_TIME_S,
    :CONC_TIME_B, :CONC_TIME_S,
    :PED_PAY_B, :PED_PAY_S,
    :CONC_PAY_B, :CONC_PAY_S,
    :SUM_PAY_B, :SUM_PAY_S,
    :SUM_TIME_B, :SUM_TIME_S,
    :ADD_SUM;

  sum_pay = nullif(coalesce(:sum_pay_b, 0) + coalesce(:sum_pay_s, 0), 0);
  total_pay = nullif(coalesce(:SUM_PAY_B, 0) + coalesce(:SUM_PAY_S, 0) + coalesce(:ADD_SUM, 0), 0);
  total_time = nullif(coalesce(:sum_time_b, 0) + coalesce(:sum_time_s, 0), 0);
...
RETURNS (
    FAMILY_AND_INITIALS VARCHAR(256))
AS
  declare variable v_name_1 varchar(256);
  declare variable v_name_2 varchar(256);
  declare variable v_name_3 varchar(256);
begin
  -- Вырезаю Фамилию
  v_name_1 = substring(name from 1 for position(' ' in name));
  name = substring(name from position(' ' in name) + 1);
  v_name_2 = substring(name from 1 for 1);
  name = substring(name from position(' ' in name) + 1);
  v_name_3 = substring(name from 1 for 1);
  family_and_initials = v_name_1 || ' ' || v_name_2 || '.' || v_name_3 || '.';
  /* Procedure Text */
  suspend;
end^
...
begin
  ...
  select
    sf.subject_id_1, sf.subject_id_2, sf.teacher_id_1, sf.teacher_id_2, sf.subj_state
  from student_filter sf
  ...
  if (:in_subject_id_1 is null and :in_subject_id_2 is null and :in_teacher_id_1 is null and :in_teacher_id_2 is null) then
    -- фильтр не задан -> возвращаем всех студентов
    for select id from "Student"
    order by id into :studentid
    do suspend;
  else
  begin
